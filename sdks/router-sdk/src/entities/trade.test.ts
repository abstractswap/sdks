import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@abstractswap/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@abstractswap/v2-sdk'
